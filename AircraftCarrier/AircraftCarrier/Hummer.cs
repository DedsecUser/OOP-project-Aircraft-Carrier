...
namespace AircraftCarrier
{
    ...
    public class Hummer:GROUND
    {
        ...
        {
            g.DrawImage(Bitmap.FromFile("C:\\Dan\\HIT שנה א\\מונחה עצמים\\AircraftCarrier\\AircraftCarrier\\AircraftCarrier\\Images\\hummer.png"), new Rectangle(Convert.ToInt32(this.X), Convert.ToInt32(this.Y+18), 100, 100));
        }
        ...
        {
            g.DrawImage(Bitmap.FromFile("C:\\Dan\\HIT שנה א\\מונחה עצמים\\AircraftCarrier\\AircraftCarrier\\AircraftCarrier\\Images\\HummerExploasion.png"), new Rectangle(Convert.ToInt32(this.X + 80), Convert.ToInt32(this.Y -12), 80, 80));
        }

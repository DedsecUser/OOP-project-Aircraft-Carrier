...
namespace AircraftCarrier
{
    ...
    public class Tank : GROUND
    {
        ...
        {
            g.DrawImage(Bitmap.FromFile("C:\\Dan\\HIT שנה א\\מונחה עצמים\\AircraftCarrier\\AircraftCarrier\\AircraftCarrier\\Images\\tank.jpg"), new Rectangle(Convert.ToInt32(this.X), Convert.ToInt32(this.Y), 100, 100));
        }
        ...
        {
            g.DrawImage(Bitmap.FromFile("C:\\Dan\\HIT שנה א\\מונחה עצמים\\AircraftCarrier\\AircraftCarrier\\AircraftCarrier\\Images\\Tank_explosion.png"), new Rectangle(Convert.ToInt32(this.X+5), Convert.ToInt32(this.Y-93), 90, 90));
        }

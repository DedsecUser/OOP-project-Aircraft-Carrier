...
namespace AircraftCarrier
{
    ...
    public class F16:AirTransport
    {
        ...
        {
            g.DrawImage(Bitmap.FromFile("C:\\Dan\\HIT שנה א\\מונחה עצמים\\AircraftCarrier\\AircraftCarrier\\AircraftCarrier\\Images\\plane.jpg"), new Rectangle(Convert.ToInt32(this.X), Convert.ToInt32(this.Y), 100, 100));
        }
        ...
        {
            g.DrawImage(Bitmap.FromFile("C:\\Dan\\HIT שנה א\\מונחה עצמים\\AircraftCarrier\\AircraftCarrier\\AircraftCarrier\\Images\\PlaneExploasion.png"), new Rectangle(Convert.ToInt32(this.X + 150), Convert.ToInt32(this.Y+90), 150, 150));
        }
